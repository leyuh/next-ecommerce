                ...
                <ul className="flex items-center gap-3">
                    {option.choices?.map(choice => {
                        ...
                        return option.name === "Color" ? (
                            ...
                            >
                                {selected && <div className="absolute w-10 h-10 rounded-full ring-2 ring-gray-300 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />}
                                {disabled && <div className="absolute w-10 h-[2px] bg-red-400 rotate-45 ring-gray-300 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-not-allowed" />}
                            </li>
                        ) : (
                            <li
                                key={choice.description}
