    ...
    return <div className="flex flex-col gap-6">
        ...
        <ul className="flex items-center gap-3">
            ...
            <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 cursor-pointer relative bg-green-500">
                <div className="absolute w-10 h-[2px] bg-red-400 rotate-45 ring-gray-300 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-not-allowed" />
            </li>
        </ul>
        ...
        <ul className="flex items-center gap-3">
            ...
            <li className="ring-1 ring-pink-200 text-white cursor-not-allowed bg-pink-200 rounded-md py-1 px-4 text-sm">Large</li>
        </ul>
    </div>
}
